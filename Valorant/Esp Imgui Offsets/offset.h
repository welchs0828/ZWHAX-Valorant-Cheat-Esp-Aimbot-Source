namespace offset
{   
    constexpr uint64_t uworld_state = 0x8e7d100;
    constexpr uint64_t uworld_key = 0x8e7d138;
    constexpr uint64_t game_instance = 0x1A8;
    constexpr uint64_t persistent_level = 0x38;
    constexpr uint64_t local_player_array = 0x40;
    constexpr uint64_t player_controller = 0x38;
    constexpr uint64_t local_player_pawn = 0x440;
    constexpr uint64_t control_rotation = 0x420;
    constexpr uint64_t player_camera_manager = 0x458;
    constexpr uint64_t relative_position = 0x1220;
    constexpr uint64_t relative_rotation = 0x122C;
    ...
    constexpr uint64_t bone_component = 0x560;
